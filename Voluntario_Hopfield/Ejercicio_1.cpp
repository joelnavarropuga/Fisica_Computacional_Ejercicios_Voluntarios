...
int main()
{
    ...
    for (int i = 0; i < N; i++)
    {
        for (int j = 0; j < N; j++) 
        {
            archivo_lectura >> patron_original[i][j];
        }
    }
    ...
    ofstream fichero_neuronas_aleatorias("Configuracion_inicial_neuronas_aleatoria.txt");
    ...
    ofstream fichero_neuronas_deformado("Configuracion_inicial_neuronas_deformada.txt");
